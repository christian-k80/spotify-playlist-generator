...
// Mindestabstand zwischen zwei Prüf-Anfragen (in Millisekunden).
// Da es seit der Spotify-Migration keinen Sammel-Endpunkt mehr gibt,
// braucht die Prüfung einen Request pro Titel. Dieses feste Tempo
// verhindert proaktiv, dass das Rate Limit überhaupt erst erreicht
// wird (statt erst danach zu reagieren).
const VALIDATE_MIN_INTERVAL_MS = 300;
        ...
        const trackResults =
            await runWithConcurrencyLimit(
                ...
                async (trackId) => {
                    ...
                    // Feste Mindestpause vor jeder Anfrage, um das
                    // Rate Limit proaktiv gar nicht erst zu erreichen.
                    await new Promise(
                        resolve => setTimeout(
                            resolve,
...
updateLoginStatus();// Spotify Playlist Generator
// OAuth 2.0 mit PKCE
